...
{: .note }
> This is a copy. `CHANGELOG.md` in the
> [repository](https://github.com/pwsh/jriver_homeassistant/blob/v2-rework/CHANGELOG.md) is
> canonical; if the two disagree, believe the repository.
